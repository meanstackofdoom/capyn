...
CAPYN v0.3 deliberately stops before blockchain settlement. The authority engine is chain-agnostic and should be proven before adding custody and transaction complexity.
