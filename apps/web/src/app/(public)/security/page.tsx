...
export const metadata = createPageMetadata({
  title: "Security",
  path: "/security",
  description: "CAPYN's fail-closed authorization model, credential handling, tenant isolation, concurrency controls, replay protection and known v0.2 limitations."
});
    ...
    <main>
      ...
      <section id="controls" className="site-section bg-panel">
        <div className="site-container">
          <SectionHeading eyebrow="Implemented in v0.2" title="Security boundaries exist in the server and repository—not in the interface." copy="The dashboard communicates policy. It does not enforce it. These controls sit in authentication, domain services, transactions and the database model." />
      ...
      <section className="site-section bg-code text-white">
        <div className="site-container grid gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 max-w-xl text-base leading-8 text-white/60">CAPYN v0.2 establishes the architecture and demonstrates its critical controls. It intentionally does not custody or move real funds.</p>
            <div className="mt-8"><TextLink href="/about#roadmap" inverse>See what comes next</TextLink></div>
          </div>
          <div className="border border-white/15">
            <div className="flex items-center gap-3 border-b border-white/15 px-5 py-4"><AlertTriangle size={16} className="text-review" /><span className="font-mono text-[9px] uppercase tracking-[.15em] text-white/55">Known v0.2 limitations</span></div>
