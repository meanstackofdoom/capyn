      ...
      <section className="site-section">
        <div className="site-container grid gap-6 lg:grid-cols-2">
          ...
          <div className="panel p-7 sm:p-10">
            ...
            <p className="mt-5 text-sm leading-7 text-muted">The v0.4 executor simulates payment. Solana/USDC, x402, Stripe or another rail can be added behind the same one-time execution contract.</p>
