...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = ["", "/activate", "/start", "/passport", "/lab", "/proof", "/case-studies/procurement-agent", "/design-partners", "/design-partners/brief", "/product", "/security", "/developers", "/pricing", "/docs", "/about"];
